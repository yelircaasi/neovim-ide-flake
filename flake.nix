{
  ...
  outputs = inputs @ { nixpkgs, flake-utils, ... }:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      # in
      rec {
        homeManagerConfiguration = let nvim-ide = import ./hm.nix {}; in {
          home.packages = nvim-ide.otherPackages;
          programs.neovim = nvim-ide.neovimSet;
          xdg.configFile = nvim-ide.xdgConfigFiles;
        }
